...
The first release candidate of tinylog 1.1 is released and can be [downloaded](/v2/download/). Thereby tinylog 1.1 is feature complete. From now on, there will only bug fixes until the major release. As with tinylog 1.0, the first release candidate without any reported bugs will be released unmodified as final tinylog 1.1.
