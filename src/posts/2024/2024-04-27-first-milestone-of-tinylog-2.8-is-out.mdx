...
The complete documentation for using the context placeholder and others placeholders can be found in the [Format Pattern](/v2/configuration/#format-pattern) chapter.
