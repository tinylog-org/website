...
The final version of tinylog 1.2 is released and can be [downloaded](/v2/download/). It is identical to the last release candidate as no further bugs have been reported.
