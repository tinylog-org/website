...
The version 0.9 of tinylog is ready and can be [downloaded](/v2/download/). This is the last beta version and all the essential features are implemented. The next version will be the first release candidate and contain only minor changes.
