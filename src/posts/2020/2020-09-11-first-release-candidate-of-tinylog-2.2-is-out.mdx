...
It is also possible to implement [custom converters](/v2/extending/#custom-file-converter) for additional compression algorithms or any other type of encoding like encryption.
