...
Today the next beta version of tinylog is released. The new version 0.7 is now available for [download](/v2/download/). Feedback (positive and negative) is still welcome!
