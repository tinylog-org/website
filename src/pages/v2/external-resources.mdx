...
description: 'Explore external resources for tinylog 2: third-party projects, example projects, insightful articles, and helpful tutorials to enhance your logging.'
...
[Tinylog: The Definitive Guide to Lightweight Java Logging](https://www.dash0.com/faq/tinylog-the-definitive-guide-to-lightweight-java-logging)  
Introduction to tinylog 2 and integration with OpenTelemetry by Dash0
...
[tinylog Tutorial](https://mkyong.com/v2/logging/tinylog-tutorial/)
