...
description: 'Get started with tinylog 2! Learn to quickly set up this lightweight Java logging framework, add log statements, and do some basic configuration.'
...
1. Download <Link href="/v2/download/">tinylog <Version /></Link> and add `tinylog-api.jar` and `tinylog-impl.jar` to your classpath. If you use a build tool such as Maven or Gradle, you can add both JAR files as [dependencies](/v2/download/).
...
For a detailed documentation of all configuration parameters, see the [configuration page](/v2/configuration/), and for all logging methods, see the [logging page](/v2/logging/).
