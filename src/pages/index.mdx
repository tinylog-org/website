...
description: 'Discover tinylog: The fast, lightweight logging framework for Java, Kotlin, Scala, and Android. Simplify development with easy configuration and static logging.'
...
import BenchmarkIcon from '../components/BenchmarkIcon.astro'
import BootstrapIcon from '../components/BootstrapIcon.astro'
import IfPreviewVersion from '../components/IfPreviewVersion.astro'
import TotalFileSize from '../components/TotalFileSize.astro'
...
<p class="lead">Simplify your logging with tinylog.
The lightweight logging framework can be used with Java, Kotlin, Scala, and any other JVM language.
tinylog is open source and runs wherever Java is used: JVM, GraalVM, and Android</p>

<div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
<a class="btn btn-outline-dark btn-lg" href="/v2/getting-started/" role="button">Getting Started</a>
<a class="btn btn-outline-dark btn-lg" href="/v2/download/" role="button">Download tinylog</a>
</div>

<p class="text-secondary">Latest Version: <a href="/v2/download/"><Version type="current" /></a>
<IfPreviewVersion> | <a href="/v2/download-preview/"><Version type="preview" /></a></IfPreviewVersion></p>
...
tinylog is typically configured via a properties file, where you can configure writers, severity level, and [much more](/v2/configuration/).
...
Example projects can be found on the [external resources page](/v2/external-resources/#example-projects).
...
All of them can be found on the [download page](/v2/download/).

</div>
<div class="sample">

<BootstrapIcon name="puzzle" />
...
Both JAR files have a combined size of only <TotalFileSize />.

</div>
<div class="sample">

<span class="display-3" aria-hidden="true"><TotalFileSize /></span>
