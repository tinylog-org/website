---
title: Download
description: 'Download tinylog including third-party logging APIs and adapters for web and application severs. Get JARs and Maven or Gradle artifacts for your JVM projects.'
tableOfContents: true
navigationParent: download
---
...
The default logging API and logging implementation of tinylog <Version type="preview" /> for Java and any other JVM language.

<Download file="tinylog" artifacts="tinylog-api tinylog-impl" bundles="org.tinylog.api org.tinylog.impl" type="preview" />

### Kotlin

Enhanced logging API for Kotlin and the default logging implementation of tinylog <Version type="preview" />.

<Download file="tinylog-kotlin" artifacts="tinylog-api-kotlin tinylog-impl" bundles="org.tinylog.api.kotlin org.tinylog.impl" type="preview" />

### Scala

Enhanced logging API for Scala and the default logging implementation of tinylog <Version type="preview" />.

<Download file="tinylog-scala" artifacts="tinylog-api-scala_2.13 tinylog-impl" bundles="org.tinylog.api.scala_2.13 org.tinylog.impl" type="preview" />
...
<Download file="jcl-tinylog" artifacts="jcl-tinylog" bundles="org.tinylog.api.jcl" type="preview" />
...
<Download file="log4j1.2-api" artifacts="log4j1.2-api" bundles="org.tinylog.api.log4j12" type="preview" />
...
<Download file="jsl-tinylog" artifacts="jsl-tinylog" bundles="org.tinylog.api.jsl" type="preview" />
...
<Download file="jul-tinylog" artifacts="jul-tinylog" bundles="org.tinylog.api.jul" type="preview" />
...
<Download file="jboss-tinylog" artifacts="jboss-tinylog" bundles="org.tinylog.api.jboss" type="preview" />
...
<Download file="slf4j-tinylog" artifacts="slf4j-tinylog" bundles="org.tinylog.api.slf4j" type="preview" />
...
<Download file="tinylog1.3-api" artifacts="tinylog1.3-api" bundles="org.tinylog.api.tinylog13" type="preview" />
...
<Download file="tinylog-jboss" artifacts="tinylog-jboss" bundles="org.tinylog.adapter.jul" type="preview" />
...
<Download file="tinylog-jul" artifacts="tinylog-jul" bundles="org.tinylog.adapter.jboss" type="preview" />
