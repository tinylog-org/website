---
title: Configuration
description: 'Learn to configure tinylog: Set up severity levels, writers, format patterns, and asynchronous writing thread via tinylog.properties or programmatically.'
