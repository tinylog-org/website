...
:------------------------|:------------
 ...
 {context: key}          | Value from [thread-based context](logging#context-values) ("key" should be replaced by a real key). If the key is omitted, all keys and their values are output since tinylog 2.8.
